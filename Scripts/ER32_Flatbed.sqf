	...
	*/
	...
	switch (count _objectsLoaded) do {
		case 0: {
			...
			*/
			[_object, 0, ["ACE_MainActions","ER32_LoadOnFlatbed"]] remoteExecCall ["ace_interact_menu_fnc_removeActionFromObject",0,true];
			
			[_nearestFlatbed,_crates] remoteExecCall ["ER32_fnc_unloadFromFlatbed",0,true];
